...
public class PlayerMovement : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        walkSpeed = moveSpeed;
        //implementing sprint difference from the walking speed
    ...
    {
        // limiting players speed on slope
        if (OnSlope() && !exitingSlope)
        {
        ...
        // limiting the players speed on ground or in the air
        else
        {
